...
- name: Slack Create Group
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/slack/usergroups-create-post.md
...
- name: Slack Create Child Group
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/slack/groups-createchild-post.md
  - type: x-postman-collection
