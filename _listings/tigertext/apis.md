...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/tigertext/apis.md
...
- name: Tiger Connect Metadata API - Clears the metadata for a User or Group based
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/tigertext/metadatagroup-token-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/tigertext/metadatagroup-token-delete-openapi.md
- name: Tiger Connect Metadata API - Get the metadata for a User or Group based on
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/tigertext/metadatagroup-token-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/tigertext/metadatagroup-token-get-openapi.md
- name: Tiger Connect Metadata API - Adds metadata for a User or Group based on address
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/tigertext/metadatagroup-token-post-openapi.md
- name: Tiger Connect Metadata API - Adds metadata for a User or Group based on address
    encoding
  x-api-slug: metadatagroup-token-post
  description: Adds metadata for a User or Group based on address encoding
