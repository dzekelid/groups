...
- name: Meetup - Profile Create (Group Join)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/meetup/2profile-post-openapi.md
- name: Meetup - Profile Delete (Leave Group)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/meetup/2profilegidmid-delete-openapi.md
- name: Meetup - Get Group
  x-api-slug: urlname-get
  description: Fetches a Meetup group by urlname
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/6564-meetup.jpg
...
- name: Meetup - Discussion Boards
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/meetup/urlnameboards-get-openapi.md
- name: Meetup - Discussion Posts
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/meetup/urlnameboardsbiddiscussionsdid-get-openapi.md
- name: Meetup - Group Events
  x-api-slug: urlnameevents-get
  description: Gets a listing of all Meetup Events hosted by a target group, in ascending
    order by default
...
- name: Meetup - Group Topics Add
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/meetup/urlnametopics-post-openapi.md
- name: Meetup - Group Topics Remove
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/meetup/urlnametopics-delete-openapi.md
- name: Meetup - Group Venues
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/meetup/urlnamevenues-get-openapi.md
x-common:
- type: x-api-gallery
