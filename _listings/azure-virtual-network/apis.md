...
- name: Azure Virtual Network API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/groups/master/_listings/azure-virtual-network/subscriptions-subscriptionid-providers-microsoft-network-networksecuritygroups-get.md
x-common:
