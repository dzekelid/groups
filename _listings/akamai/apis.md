...
- name: Akamai API Get a Property
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/groups/master/_listings/akamai/user-admin-v1-accounts-accountid-groups-groupid-properties-assetid-get.md
x-common:
- type: x-base
